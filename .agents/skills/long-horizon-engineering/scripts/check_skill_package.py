...
PACKAGE_ONLY_FILES = [
    ...
    "scripts/assemble_skill_profile.py",
    "scripts/skill_update_selfcheck.py",
    "scripts/test_assemble_skill_profile.py",
...
INSTALLED_REQUIRED_FILES = [
    ...
    ".agents/skills/long-horizon-engineering/references/safe-project-context-map.md",
...
AI_VIDEO_REQUIRED_FILES = [
    ...
    ".agents/skills/ai-video-production/references/video-skill-integration-catalog.md",
    ...
    ".agents/skills/ai-video-production/templates/SHORT_FORM_PRODUCTION_PACKET_TEMPLATE.md",
