...
REQUIRED_FILES = [
    ...
    ".agents/skills/long-horizon-engineering/references/evidence-backed-writing-protocol.md",
    ...
    ".agents/skills/long-horizon-engineering/references/notebook-data-analysis-protocol.md",
    ...
    ".agents/skills/long-horizon-engineering/templates/notebook-analysis-plan.md",
    ".agents/skills/long-horizon-engineering/templates/presentation-outline.md",
    ".agents/skills/long-horizon-engineering/templates/research-claim-evidence.md",
...
AI_VIDEO_REQUIRED_FILES = [
    ...
    ".agents/skills/ai-video-production/references/video-design-system.md",
    ".agents/skills/ai-video-production/templates/VIDEO_BRIEF_TEMPLATE.md",
    ".agents/skills/ai-video-production/templates/VIDEO_DESIGN_SYSTEM_TEMPLATE.md",
    ".agents/skills/ai-video-production/templates/STYLE_BOARD_TEMPLATE.md",
