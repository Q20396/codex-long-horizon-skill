...
through `marketplace upgrade`. For a verified v0.4.0 upgrade, first
...
The release-state contract marks `v0.4.0` stable and `AVAILABLE`. Before any
...
1. Resolve v0.4.0 to an exact peeled commit SHA.
