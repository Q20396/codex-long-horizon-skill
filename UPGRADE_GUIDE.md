...
through `marketplace upgrade`. For a verified v0.6.1 upgrade, first
...
The release-state contract marks `v0.6.1` stable and `AVAILABLE`. Before any
...
1. Resolve v0.6.1 to an exact peeled commit SHA.
