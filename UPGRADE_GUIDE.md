...
through `marketplace upgrade`. For a verified v0.5.0 upgrade, first
...
The release-state contract marks `v0.5.0` stable and `AVAILABLE`. Before any
...
1. Resolve v0.5.0 to an exact peeled commit SHA.
